...
gsnap -D ~/dbcenter/OS_indica -d indica_ASM465v1.25_gsnap -m 10 -i 2 -N 1 -w 10000 -A sam -t 8 -n 3 --quality-protocol=sanger --nofails leaf.rep1_1.fastq leaf.rep1_2.fastq --split-output SRR1170742
