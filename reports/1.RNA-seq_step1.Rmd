...
cat SRR1170742.sra_1.fastq | awk 'NR >= 4000001  && NR <= 8000000 { print }' > leaf.rep1_1.fastq
cat SRR1170742.sra_2.fastq | awk 'NR >= 4000001  && NR <= 8000000 { print }' > leaf.rep1_2.fastq
cat SRR1170742.sra_1.fastq | awk 'NR >= 14000001  && NR <= 18000000 { print }' > leaf.rep2_1.fastq
cat SRR1170742.sra_2.fastq | awk 'NR >= 14000001  && NR <= 18000000 { print }' > leaf.rep2_2.fastq
cat SRR1170742.sra_1.fastq | awk 'NR >= 24000001  && NR <= 28000000 { print }' > leaf.rep3_1.fastq
cat SRR1170742.sra_2.fastq | awk 'NR >= 24000001  && NR <= 28000000 { print }' > leaf.rep3_2.fastq

wc -l SRR1170744.sra_1.fastq 
#151937424 SRR1170744.sra_1.fastq

cat SRR1170744.sra_1.fastq | awk 'NR >= 4000001  && NR <= 8000000 { print }' > root.rep1_1.fastq
cat SRR1170744.sra_2.fastq | awk 'NR >= 4000001  && NR <= 8000000 { print }' > root.rep1_2.fastq
cat SRR1170744.sra_1.fastq | awk 'NR >= 14000001  && NR <= 18000000 { print }' > root.rep2_1.fastq
cat SRR1170744.sra_2.fastq | awk 'NR >= 14000001  && NR <= 18000000 { print }' > root.rep2_2.fastq
cat SRR1170744.sra_1.fastq | awk 'NR >= 24000001  && NR <= 28000000 { print }' > root.rep3_1.fastq
cat SRR1170744.sra_2.fastq | awk 'NR >= 24000001  && NR <= 28000000 { print }' > root.rep3_2.fastq
